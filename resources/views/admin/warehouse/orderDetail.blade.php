...
<div class="row">
          ...
          <table id="product-table" class="table table-hover" style="width:100%; min-width: 985px;">
            <thead>
              <tr>
                ...
                <th data-width="100px">Colors</th>
                <th data-width="120px">Quantity Sold</th>
                <th data-width="100px" data-type="date-euro">Date of Sale</th>
              </tr>
            </thead>
            <tbody>
    ...
    <div class="row no-print">
      <div class="col-xs-12">
        <button class="btn btn-success btn-print pull-right" onclick="printPDF()" ><i class="fa fa-print"></i> Print Invoice</button>
      </div>
    </div>
    <!-- /.col -->
  </div>
