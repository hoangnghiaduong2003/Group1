          ...
          <table id="product-table" class="table table-hover" style="width:100%; min-width: 985px;">
            <thead>
              <tr>
                ...
                <th data-width="90px">Operating system</th>
                <th data-width="66px">Color</th>
                <th data-width="100px">The number of import</th>
                <th data-width="66px">Sold</th>
                <th data-width="66px">Remaining</th>
                <th data-width="70px" data-type="date-euro">Date Added</th>
              </tr>
            </thead>
            <tbody>
