      ...
      <div class="box">
        ...
        <div class="box-body">
          <table id="product-table" class="table table-hover" style="width:100%; min-width: 985px;">
            <thead>
              <tr>
                <th data-width="10px">Numerical order</th>
                <th data-orderable="false" data-width="75px">Image</th>
                <th data-orderable="false" data-width="85px">Product code</th>
                <th data-orderable="false">Product's name</th>
                <th data-width="90px">Manufacturer</th>
                <th data-width="85px">Operating system</th>
                <th data-width="60px">Evaluate</th>
            ...
            <tbody>
              @foreach($products as $key=>$product)
                <tr>
                  ...
                  <td>{{ $product->OS }}</td>
                  <td>{{ $product->rate }}/5 Point</td>
                  <td> {{ \Carbon\Carbon::parse($product->created_at)->format('d/m/Y')}}</td>
                  <td>
                    @if($product->product_details_count > 0)
                      <span class="label-success status-label">Stocking</span>
                    @else
                      <span class="label-danger status-label">Out of stock</span>
                    @endif
                  </td>
                  <td>
