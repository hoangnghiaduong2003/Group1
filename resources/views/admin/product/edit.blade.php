...
<ol class="breadcrumb">
  ...
  <li><a href="{{ route('admin.product.index') }}"><i class="fa fa-product-hunt" aria-hidden="true"></i> Product Management</a></li>
...
<form id="productForm" action="{{ route('admin.product.update', ['id' => $product->id]) }}" method="POST" accept-charset="utf-8" enctype="multipart/form-data">
  ...
  <div class="box box-primary">
    ...
    <div class="box-body">
      <div class="row">
        <div class="col-md-3">
          <label for="title">Pictures Show <span class="text-red">*</span></label>
        ...
        <div class="col-md-9">
          <div class="row">
            <div class="col-md-4">
              <div class="form-group">
                <label for="name">Product's name <span class="text-red">*</span></label>
            ...
            <div class="col-md-4">
              <div class="form-group">
                <label for="sku_code">Product code <span class="text-red">*</span></label>
          ...
          <div class="row">
            <div class="col-md-4">
              <div class="form-group">
                <label for="monitor">Screen <span class="text-red">*</span></label>
            ...
            <div class="col-md-4">
              <div class="form-group">
                <label for="front_camera">Front camera <span class="text-red">*</span></label>
            ...
            <div class="col-md-4">
              <div class="form-group">
                <label for="rear_camera">Rear Camera <span class="text-red">*</span></label>
          ...
          <div class="row">
            <div class="col-md-4">
              <div class="form-group">
                <label>Operating system <span class="text-red">*</span></label>
  ...
  <div class="box box-primary">
    ...
    <div class="box-body">
            ...
            <div class="row">
              <div class="col-md-6">
                <div class="form-group" style="margin-bottom: 0;">
                  <label for="old_promotion_{{ $promotion->id }}">Promotion<span class="text-red">*</span></label>
      ...
      <div class="text-center">
        <button class="add-promotion btn btn-success"><i class="fa fa-plus" aria-hidden="true"></i>More Promotions</button>
      </div>
    </div>
  </div>
  <div class="box box-primary">
    <div class="box-header with-border">
      <h3 class="box-title">Product Color and Price Information</h3>
      <div class="box-tools">
        <!-- This will cause the box to collapse when clicked -->
        <button class="btn btn-box-tool" data-widget="collapse" data-toggle="tooltip" title="Collapse"><i class="fa fa-minus"></i></button>
      </div>
          ...
          <div class="box box-solid box-default collapsed-box" style="margin-bottom: 5px;">
            ...
            <div class="box-body" style="display: none;">
              <div class="row">
                <div class="col-md-4">
                  <div class="form-group">
                    <label for="color_{{ $product_detail->id }}">Colors<span class="text-red">*</span></label>
                ...
                <div class="col-md-4">
                  <div class="form-group">
                    <label for="quantity_{{ $product_detail->id }}">Quantity<span class="text-red">*</span></label>
                ...
                <div class="col-md-4">
                  <div class="form-group">
                    <label for="import_price_{{ $product_detail->id }}">Entry Price ($) <span class="text-red">*</span></label>
              ...
              <div class="row">
                <div class="col-md-4">
                  <div class="form-group">
                    <label for="sale_price_{{ $product_detail->id }}">price ($) <span class="text-red">*</span></label>
                ...
                <div class="col-md-4">
                  <div class="form-group">
                    <label for="promotion_price_{{ $product_detail->id }}">Promotion Price ($)</label>
              ...
              <div class="form-group" style="margin-bottom: 0;">
                <label>Detail Images <span class="text-red">*</span></label>
    ...
    <div class="text-center box-footer">
      <button class="add btn btn-success"><i class="fa fa-plus" aria-hidden="true"></i>More Product Colors</button>
    </div>
  </div>
  <div class="nav-tabs-custom">
    <ul class="nav nav-tabs">
      <li class="active"><a href="#product-information" data-toggle="tab">Detailed Configuration</a></li>
      <li><a href="#product-introduction" data-toggle="tab">Articles Products</a></li>
    </ul>
  ...
  <div class="box box-solid">
    <div class="box-body">
      <div class="form-group">
        ...
        <a href="{{ route('admin.product.index') }}" class="btn btn-danger btn-flat pull-right" style="margin-right: 5px;"><i class="fa fa-ban" aria-hidden="true"></i>Cancel</a>
      </div>
    </div>
  </div>
</form>
  ...
  <div class="box box-solid box-default" style="margin-bottom: 5px;">
    ...
    <div class="box-body">
      <div class="row">
        <div class="col-md-4">
          <div class="form-group">
            <label for="color_{?}">Colors<span class="text-red">*</span></label>
        ...
        <div class="col-md-4">
          <div class="form-group">
            <label for="quantity_{?}">Quantity<span class="text-red">*</span></label>
        ...
        <div class="col-md-4">
          <div class="form-group">
            <label for="import_price_{?}">Entry Price ($) <span class="text-red">*</span></label>
      ...
      <div class="row">
        <div class="col-md-4">
          <div class="form-group">
            <label for="sale_price_{?}">Price($) <span class="text-red">*</span></label>
        ...
        <div class="col-md-4">
          <div class="form-group">
            <label for="promotion_price_{?}">Promotion Price($)</label>
  ...
  <div class="box box-solid box-default" style="margin-bottom: 5px;">
    ...
    <div class="box-body">
      <div class="row">
        <div class="col-md-6">
          <div class="form-group" style="margin-bottom: 0;">
            <label for="promotion_{?}">Promotion <span class="text-red">*</span></label>
