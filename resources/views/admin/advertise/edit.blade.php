...
<ol class="breadcrumb">
  ...
  <li class="active">Editing Ads</li>
</ol>
@endsection
            ...
            <div class="col-md-5">
              <div class="form-group">
                  ...
                  <select class="form-control" name="at_home_page">
                    <option value="0"  @if( old('at_home_page') == NULL ) {{ $advertise->at_home_page ? '' : 'selected' }} @else {{ old('at_home_page') ? '' : 'selected' }} @endif>Regular Page</option>
                    <option value="1"  @if( old('at_home_page') == NULL ) {{ $advertise->at_home_page ? 'selected' : '' }} @else {{ old('at_home_page') ? 'selected' : '' }} @endif>Home page</option>
                  </select>
                </div>
            </div>
            <div class="col-md-7">
