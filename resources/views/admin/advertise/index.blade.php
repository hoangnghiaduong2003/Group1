            ...
            <div class="col-md-7 col-sm-6 col-xs-6">
              <div class="btn-group pull-right">
                ...
                <a href="{{ route('admin.advertise.new') }}" class="btn btn-success btn-flat" title="Thêm Mới">
                  <i class="fa fa-plus" aria-hidden="true"></i><span class="hidden-xs"> Add New</span>
                </a>
              </div>
            </div>
          </div>
          ...
          <table id="advertise-table" class="table table-hover" style="width:100%; min-width: 768px;">
            <thead>
              <tr>
                ...
                <th data-orderable="false" data-width="100px">Image</th>
                <th data-orderable="false">Title</th>
                <th data-orderable="false" data-width="85px">Display</th>
                <th data-width="60px" data-type="date-euro">Date created</th>
                <th data-width="66px">Status</th>
                <th data-orderable="false" data-width="70px">Tash</th>
              </tr>
            </thead>
            <tbody>
