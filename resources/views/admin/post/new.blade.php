...
<ol class="breadcrumb">
  ...
  <li><a href="{{ route('admin.post.index') }}"><i class="fa fa-newspaper-o" aria-hidden="true"></i> Post Management</a></li>
...
<form action="{{ route('admin.post.save') }}" method="POST" accept-charset="utf-8" enctype="multipart/form-data">
  ...
  <div class="row">
    ...
    <div class="col-md-3">
      <div class="box box-primary">
        <div class="box-header with-border"><b>Image</b> <span class="text-red">*</span></div>
        <div class="box-body">
      ...
      <div class="box box-primary">
        <div class="box-header with-border"><b>Post</b></div>
        <div class="box-body">
          <a href="{{ route('admin.post.index') }}" class="btn btn-danger btn-flat"><i class="fa fa-ban" aria-hidden="true"></i>Cancel</a>
