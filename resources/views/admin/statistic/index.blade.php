    ...
    <div class="col-md-12">
      <div class="box">
              ...
              <div class="box-body">
                ...
                <div class="row">
                  <div class="col-md-4 col-sm-4 col-xs-4">
                    ...
                    <!-- /.chart-responsive -->
                    <p class="text-center">
                      <i>Figure 2: Market share of products sold by manufacturer</i>
                    </p>
                  </div>
                  <!-- /.col -->
                  <div class="col-md-4 col-sm-4 col-xs-4">
                    ...
                    <!-- /.chart-responsive -->
                    <p class="text-center">
                      <i>Figure 3: Revenue share by manufacturer</i>
                    </p>
                  </div>
                  <!-- /.col -->
                  <div class="col-md-4 col-sm-4 col-xs-4">
                    ...
                    <!-- /.chart-responsive -->
                    <p class="text-center">
                      <i>Figure 4: Profit share by manufacturer</i>
                    </p>
                  </div>
                  <!-- /.col -->
                </div>
                ...
                <div class="row">
                  ...
                  <div class="col-sm-3 col-xs-3">
                    <div class="description-block border-right description-product">
                      ...
                      <span class="description-text">Product sold</span>
                    </div>
                    <!-- /.description-block -->
                  </div>
                  <!-- /.col -->
              ...
              <div class="box-body">
                <div class="table-responsive">
                  <table class="table table-striped">
                    <thead>
                      <tr>
                        <th style="text-align: center; vertical-align: middle;">numerical order</th>
                        <th style="vertical-align: middle;">Product code</th>
                        <th style="vertical-align: middle;">Product's name</th>
                        <th style="vertical-align: middle;">Colors</th>
                        <th style="vertical-align: middle;">Order</th>
                        <th style="vertical-align: middle;">Export Date</th>
                        <th style="text-align: center; vertical-align: middle;">Quantity</th>
                        <th style="vertical-align: middle;">Entry Price</th>
                        <th style="vertical-align: middle;">Export Price</th>
                    ...
                    <tbody>
                      ...
                      @foreach($data['order_details'] as $key => $order_detail)
                        ...
                        <tr>
                          ...
                          <td style="vertical-align: middle;"><span style="color: #f30;">{{ number_format($order_detail->product_detail->import_price,0,',','.') }} $</span></td>
                          <td style="vertical-align: middle;"><span style="color: #f30;">{{ number_format($order_detail->price,0,',','.') }} $</span></td>
                          <td style="vertical-align: middle;"><span style="color: #f30;">{{ number_format($order_detail->price * $order_detail->quantity,0,',','.') }} $</span></td>
                          <td style="vertical-align: middle;"><span style="color: #f30;">{{ number_format($order_detail->quantity * ($order_detail->price - $order_detail->product_detail->import_price),0,',','.') }} $</span></td>
                        </tr>
                      @endforeach
                      <tr>
                        <td colspan="11" style="text-align: right;">
                          <i style="margin-right: 10px;">*Total revenue = <span style="color: #f30;">{{ number_format($price,0,',','.') }} $</span></i>
                          <i>*Total profit = <span style="color: #f30;">{{ number_format($profit,0,',','.') }} $</span></i>
                        </td>
                      </tr>
                    </tbody>
                  </table>
        ...
        <div class="box-footer">
          <div class="row">
            <div class="col-xs-12">
              <button class="btn btn-success btn-print pull-right"><i class="fa fa-print"></i> Print Report</button>
            </div>
          </div>
        </div>
        <!-- /.box-footer -->
