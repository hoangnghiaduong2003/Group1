                    ...
                    @foreach($data['product_details'] as $key => $product)
                      ...
                      @endif
                        @if($product->promotion_price != null && $product->promotion_start_date <= date('Y-m-d') && $product->promotion_end_date >= date('Y-m-d'))
                          <div class="sale-price">{{ number_format($product->promotion_price,0,',','.') }} <span>$</span></div>
                          <div class="promotion-price">
                            <div class="old-price">Giá cũ: <del>{{ number_format($product->sale_price,0,',','.') }}</del> <span>$</span></div>
                            <div class="save-price">Giảm: <span>{{ number_format($product->sale_price - $product->promotion_price,0,',','.') }}</span> <span>$</span></div>
                          </div>
                        @else
                          <div class="sale-price">{{ number_format($product->sale_price,0,',','.') }} <span>$</span></div>
                        @endif
                    ...
                    <form action="{{ route('show_checkout') }}" method="POST" accept-charset="utf-8">
                      ...
                      <div class="row">
                        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">
                          <button type="submit" class="btn btn-lg btn-gray"><i class="far fa-money-bill-alt"></i> Buy now</button>
                        </div>
                        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">
                          <button type="button" data-role="addtocart" class="btn btn-lg btn-gray btn-cart btn_buy add_to_cart" data-url="{{ route('add_cart') }}"><span class="txt-main"><i class="fa fa-cart-arrow-down padding-right-10"></i> Cart</span></button>
                        </div>
                      </div>
                    </form>
                  </div>
              ...
              <div class="tab-description">
                ...
                <div class="tab-content">
                  <div id="description" class="tab-pane fade in active">
                    ...
                    <div class="loadmore" style="display: none;"><a>Read more <i class="fas fa-angle-down"></i></a></div>
                    <div class="hidemore" style="display: none;"><a>Shorten <i class="fas fa-angle-up"></i></a></div>
                  </div>
                    ...
                    <div class="content-vote">
                        ...
                        <div class="rating-content">
                          ...
                          <div class="rating-form">
                            <form action="{{ route('add_vote') }}" method="POST" accept-charset="utf-8">
                              ...
                              <button type="submit" class="btn btn-default">Submit a review</button>
                            </form>
                          </div>
                        </div>
                      </div>
                      ...
                      <div class="show-rate">
                        ...
                        <div class="show-rate-content">
                          ...
                          @else
                            <p class="text-center"><strong>There are no user reviews yet. Let us know your opinion.</strong></p>
                          @endif
                        </div>
                      </div>
                    </div>
              ...
              <div class="infomation-detail">
                ...
                <div class="infomation-content">
                  <ul>
                    ...
                    <li><label>Internal memory:</label>{{ $data['product']->ROM != 0 ? $data['product']->ROM.' GB' : 'Đang Cập Nhật...' }}</li>
