        ...
        <div class="col-md-4">
          <div class="new-posts">
            <div class="posts-header">
              <h3 class="posts-title">TECH NEWS</h3>
            </div>
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-6" style="display: flex;">
                        <div class="product-details">
                          <p><strong><i class="fas fa-tv"></i> Screen: </strong>{{ $product->monitor }}</p>
                          <p><strong><i class="fas fa-camera-retro"></i> Front camera: </strong>{{ $product->front_camera }}</p>
                          <p><strong><i class="fas fa-camera-retro"></i> Rear camera: </strong>{{ $product->rear_camera }}</p>
                          ...
                          <p><strong><i class="fas fa-hdd"></i> Internal memory: </strong>{{ $product->ROM }}GB</p>
                          ...
                          @endif
                          <p><strong><i class="fas fa-battery-full"></i> Battery capacity: </strong>{{ $product->pin }}</p>
                        </div>
                      </div>
                    </div>
                  </a>
