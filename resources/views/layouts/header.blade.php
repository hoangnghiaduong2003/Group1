                ...
                <ul>
                  <li class="menu-item dropdown {{ Helper::check_active(['orders_page', 'order_page', 'show_user', 'edit_user']) }}">
                    ...
                    <ul class="dropdown-menu">
                      @if(Auth::user()->admin)
                      <li><a href="{{ route('admin.dashboard') }}"><i class="fas fa-tachometer-alt"></i> Website Management</a></li>
                      @else
                      <li class="{{ Helper::check_active(['orders_page', 'order_page']) }}"><a href="{{ route('orders_page') }}"><i class="fas fa-clipboard-list"></i> Order Management</a></li>
                      <li class="{{ Helper::check_active(['show_user', 'edit_user']) }}"><a href="{{ route('show_user') }}"><i class="fas fa-user-cog"></i> Account Management</a></li>
                      @endif
  ...
  <div class="mobile-main-menu-middle">
    ...
    <div class="mb-menu-middle-body">
      <ul>
        ...
        <li class="mb-nav-item {{ Helper::check_active(['orders_page', 'order_page']) }}"><a href="{{ route('orders_page') }}"><span class="fas fa-clipboard-list"></span> Order form</a></li>
        @endif
      </ul>
    </div>
  </div>
  <div class="mobile-main-menu-bottom">
    <div class="mobile-support">
      ...
      <div class="info-support">
        <i class="fa fa-phone" aria-hidden="true"></i> HOTLINE: <a href="tel: +84 123465789" title="(+84) 123456789">(+84) 12345679</a>
      </div>
      <div class="info-support">
        <i class="fa fa-envelope" aria-hidden="true"></i> EMAIL: <a href="mailto:hoangnghiaduong0@gmail.com" title="hoangnghiaduong0@gmail.com">hoangnghiaduong0@gmail.com</a>
      </div>
    </div>
  </div>
</div>
